    ...
    return (
      <div className="pt-24 pb-16 px-6 min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="font-serif text-2xl text-charcoal mb-4">{t('cart.empty')}</h1>
    ...
    return (
      <div className="pt-24 pb-16 px-6 min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <h1 className="font-serif text-3xl text-charcoal mb-4">{t('checkout.success')}</h1>
  ...
  return (
    <div className="pt-24 pb-16 px-6 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="font-serif text-4xl text-charcoal mb-8">{t('checkout.title')}</h1>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-8">
              <ScrollReveal>
                <div className="bg-cream-dark/20 rounded-lg p-6">
                  <h2 className="font-serif text-xl text-charcoal mb-6">{t('checkout.shippingInfo')}</h2>
              ...
              <ScrollReveal>
                <div className="bg-cream-dark/20 rounded-lg p-6">
                  <h2 className="font-serif text-xl text-charcoal mb-6">{t('checkout.payment')}</h2>
                  <div className="space-y-3">
                    {paymentMethods.map((method) => (
                      ...
                      >
                        ...
                        <span className="text-charcoal">{method.label}</span>
                      </label>
                    ))}
                  </div>
                </div>
              ...
              <button
                type="submit"
                className="w-full bg-charcoal text-cream py-4 rounded hover:bg-gold transition-colors font-medium"
              >
                {t('checkout.confirmPay')} ¥{totalPrice()}
              </button>
            </form>
          </div>
          ...
          <ScrollReveal>
            <div className="bg-cream-dark/20 rounded-lg p-6 h-fit sticky top-28">
              <h2 className="font-serif text-xl text-charcoal mb-6">{t('checkout.orderDetails')}</h2>
                  ...
                  return (
                    <div key={item.productId} className="flex gap-4">
                      ...
                      <div className="flex-1">
                        <p className="text-charcoal text-sm">{product.name[lang]}</p>
              ...
              <div className="border-t border-cream-dark pt-4 space-y-2">
                ...
                <div className="flex justify-between font-serif text-lg text-charcoal pt-2">
